<?php
    ...
    class Usuario extends Model {
        ...
        //Recuperar total de usuários seguidos do usuário autenticado
        ...
        public function getTotalSeguidores() {
            $query = "select count(*) as total_segidores from usuarios_seguidores where id_usuario_seguindo =:id_usuario";
            $stmt = $this->db->prepare($query);
            $stmt->bindValue(':id_usuario', $this->__get('id'));
            $stmt->execute();
            return $stmt->fetch(\PDO::FETCH_ASSOC);
